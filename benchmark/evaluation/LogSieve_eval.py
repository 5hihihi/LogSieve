...
from LogSieve_benchmark import benchmark_settings
from logparser.LogSieve import LogParser
...
if __name__ == "__main__":
    ...
    output_dir = f"../../result/result_LogSieve_{data_type}"
    ...
    post_average(metric_file, f"LogSieve_{data_type}_complex={args.complex}_frequent={args.frequent}", args.complex, args.frequent)
